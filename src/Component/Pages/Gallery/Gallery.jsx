...
const Gallery = () => {
    ...
    return (
        <div className='max-w-screen-lg mx-auto mt-28'>
            <h4 className='text-color md:text-left md:text-lg sm:text-base sm:text-center'>TOP DESTINATION</h4>
            <h2 className='md:text-left md:text-6xl sm:text-4xl font-extrabold sm:text-center'>POPULAR <span className='text-color'> DESTINATION</span></h2>
