...
const Blog = () => {
    return (
        <div className='max-w-screen-lg flex md:flex-row sm:flex-col-reverse  items-center justify-between sm:text-center md:text-left mx-auto mt-28'>
            <div className='w-3/4 md:mt-0 sm:mt-8'>
                <h4 className='text-color'>We  Provide Top Destinations Especially Book Now and chill!</h4>
                <h2 className='text-5xl font-extrabold text-blue-900'>DISCOVER THE <span className='text-color'>WORLD</span></h2>
                <h2 className='text-5xl mt-2 font-extrabold text-blue-900'>WITH OUR GUIDE</h2>

                <p className='mr-10 mt-5 sm:text-center md:text-left text-justify '>Dream Explorer offers a wide range of travel packages to destinations all over the world, from budget-friendly options to luxurious experiences. We cater to families, couples, and solo travelers. Our experienced travel agents will work with you to create a customized itinerary that fits your needs and budget. We also offer a 100% satisfaction guarantee.Contact us today to start planning your dream vacation!</p>
