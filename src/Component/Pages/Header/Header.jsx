...
window.addEventListener('scroll', () => {
    ...
    const menu = <>
                   <Link className='hover-color font-bold hover:md:px-5 block mb-2' to='/'>Home</Link>                    {
                        ...
                        <>
                            ...
                            <Link className='mb-2 flex'><img className='rounded-full w-7 h-7 md:mr-1' src={users.photoURL} alt="" /><span className='hover:md:px-5 hover-color'>{users.displayName}</span></Link>
    ...
    return (
        <div>
            <nav className='header fixed text-black top-0 right-0 left-0 z-50 p-4 md:px-28'>
